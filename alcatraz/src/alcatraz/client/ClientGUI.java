...
/**
 * This class creates the GUI for the Client registration and information output
 * @author Azimikhah
 * @author Bichler
 * @author Seidl
 */
public class ClientGUI extends JFrame {
    ...
    public ClientGUI(final RemotePlayer p) {
        ...
        btnUnregister.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                //gets the backup server address
        ...
        btnRegister.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                if (gatherFieldInformation(p) == true) {
                    /* publishes the client object - afterwards the remoteplayer with the rmiUri gets
    ...
    //places the game board on the right side of the window
    public void setBoard(JPanel board) {
        board.setBounds(230, 0, 550, 700);
        contentPane.add(board);
    }

    //sends a message to the output area
